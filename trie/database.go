...
type Database struct {
	diskdb kddb.Database // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb kddb.Database) *Database {
	return &Database{
		diskdb: diskdb,
...
func (db *Database) commit(hash common.Hash, batch kddb.Batch) error {
	// If the node does not exist, it's a previously committed node
