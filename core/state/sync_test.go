...
// account array.
func checkStateAccounts(t *testing.T, db kddb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db kddb.Database, root common.Hash) error {
...
func checkStateConsistency(db kddb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(kddb.Database), srcRoot)
