...
//
// Detailed usage document and tutorial available on the go-kdchain Wiki page:
// https://github.com/kdchain/go-kdchain/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
