...
type downloadTester struct {
	...
	stateDb kddb.Database // Database used by the tester for syncing from peers
	peerDb  kddb.Database // Database of the peers containing all data
...
func newTester() *downloadTester {
	...
	tester.stateDb, _ = kddb.NewMemDatabase()
