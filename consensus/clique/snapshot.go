...
func loadSnapshot(config *params.CliqueConfig, sigcache *lru.ARCCache, db kddb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db kddb.Database) error {
