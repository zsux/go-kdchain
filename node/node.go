...
func New(conf *Config) (*Node, error) {
	...
	// We rely on this in cmd/gkdchain.
...
func (n *Node) OpenDatabase(name string, cache, handles int) (kddb.Database, error) {
	if n.config.DataDir == "" {
		return kddb.NewMemDatabase()
	}
	return kddb.NewLDBDatabase(n.config.resolvePath(name), cache, handles)
}
