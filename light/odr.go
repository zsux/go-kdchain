...
func (req *TrieRequest) StoreResult(db kddb.Database) {
	req.Proof.Store(db)
}
...
// StoreResult stores the retrieved data in local database
func (req *CodeRequest) StoreResult(db kddb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *BlockRequest) StoreResult(db kddb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *ReceiptsRequest) StoreResult(db kddb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *ChtRequest) StoreResult(db kddb.Database) {
...
// StoreResult stores the retrieved data in local database
func (req *BloomRequest) StoreResult(db kddb.Database) {
