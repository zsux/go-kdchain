...
type accessTestFn func(db kddb.Database, bhash common.Hash, number uint64) light.OdrRequest

func TestBlockAccessLes1(t *testing.T) { testAccess(t, 1, tfBlockAccess) }

func TestBlockAccessLes2(t *testing.T) { testAccess(t, 2, tfBlockAccess) }

func tfBlockAccess(db kddb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfReceiptsAccess(db kddb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfTrieEntryAccess(db kddb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfCodeAccess(db kddb.Database, bhash common.Hash, number uint64) light.OdrRequest {
