...
// Supported versions of the kd protocol (first is primary).
...
// kd protocol message codes
const (
	// Protocol messages belonging to kd/62
	StatusMsg          = 0x00
	...
	// Protocol messages belonging to kd/63
	GetNodeDataMsg = 0x0d
	NodeDataMsg    = 0x0e
	GetReceiptsMsg = 0x0f
	ReceiptsMsg    = 0x10
