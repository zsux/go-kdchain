...
import (
	...
	gkdchainmetrics "github.com/kdchain/go-kdchain/metrics"
	"github.com/kdchain/go-kdchain/metrics/influxdb"
...
func Setup(ctx *cli.Context) {
	if gkdchainmetrics.Enabled {
		...
		if enableExport {
			...
			go influxdb.InfluxDBWithTags(gkdchainmetrics.DefaultRegistry, 10*time.Second, endpoint, database, username, password, "swarm.", map[string]string{
				"host": hosttag,
			})
		}
	}
