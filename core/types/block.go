...
// a block's data contents (transactions and uncles) togkdchainer.
type Body struct {
...
type Block struct {
	...
	// These fields are used by package kd to track
...
// "external" block encoding. used for kd protocol, etc.
