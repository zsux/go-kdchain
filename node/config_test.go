...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gkdchain.ipc", false, filepath.Join(os.TempDir(), "gkdchain.ipc")},
		{"data", "gkdchain.ipc", false, "data/gkdchain.ipc"},
		{"data", "./gkdchain.ipc", false, "./gkdchain.ipc"},
		{"data", "/gkdchain.ipc", false, "/gkdchain.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gkdchain.ipc", true, `\\.\pipe\gkdchain.ipc`},
		{"data", "gkdchain.ipc", true, `\\.\pipe\gkdchain.ipc`},
		{"data", `\\.\pipe\gkdchain.ipc`, true, `\\.\pipe\gkdchain.ipc`},
	}
