...
type Fetcher struct {
	...
	fetchingHook       func([]common.Hash)     // Method to call upon starting a block (kd/61) or header (kd/62) fetch
	completingHook     func([]common.Hash)     // Method to call upon starting a block body fetch (kd/62)
	importedHook       func(*types.Block)      // Method to call upon successful block import (both kd/61 and kd/62)
}
