...
import (
	...
	"github.com/kdchain/go-kdchain/log/term"
	"github.com/kdchain/go-kdchain/metrics"
	"github.com/kdchain/go-kdchain/metrics/exp"
...
var (
	...
	vmoduleFlag = cli.StringFlag{
		Name:  "vmodule",
		Usage: "Per-module verbosity: comma-separated list of <pattern>=<level> (e.g. kd/*=5,p2p=4)",
		Value: "",
	}
