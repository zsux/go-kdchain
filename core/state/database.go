...
type Trie interface {
	...
	Prove(key []byte, fromLevel uint, proofDb kddb.Putter) error
}
...
func NewDatabase(db kddb.Database) Database {
...
func (m cachedTrie) Prove(key []byte, fromLevel uint, proofDb kddb.Putter) error {
