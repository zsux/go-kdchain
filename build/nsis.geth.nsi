...
# 1. install gkdchain for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gkdchain
# 5. create gkdchain, attach and uninstall start menu entries
...
function .onInit
  # make vars are global for all users since gkdchain is installed global
