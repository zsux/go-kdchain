...
import (
	...
	"github.com/kdchain/go-kdchain/tests"
)
...
var makeTest = function(tx, rewind) {
  ...
  var block   = kd.getBlock(kd.getTransaction(tx).blockHash);
  var genesis = kd.getBlock(block.parentHash);
  ...
  genesis.config = admin.nodeInfo.protocols.kd.config;
