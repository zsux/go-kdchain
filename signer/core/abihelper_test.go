...
import (
	...
	"github.com/kdchain/go-kdchain/accounts/abi"
...
func TestNewUnpacker(t *testing.T) {
	...
	testcases := []unpackTest{
		...
		}, { // https://github.com/kdchain/wiki/wiki/Ethereum-Contract-ABI#examples
...
[
	...
	for _, hexdata := range []string{
		...
		// From https://github.com/kdchain/wiki/wiki/Ethereum-Contract-ABI
