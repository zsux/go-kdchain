...
func newTestLDB() (*kddb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "kddb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := kddb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func testPutGet(db kddb.Database, t *testing.T) {
	t.Parallel()
...
func testParallelPutGet(db kddb.Database, t *testing.T) {
	const n = 8
