...
func makeHeaderChain(parent *types.Header, n int, db kddb.Database, seed int) []*types.Header {
...
// header only chain.
func newCanonical(n int) (kddb.Database, *LightChain, error) {
...
func (odr *dummyOdr) Database() kddb.Database {
	return odr.db
}
