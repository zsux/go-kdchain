Name "gkdchain ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/kdchain/go-kdchain/issues"
!define UPDATEURL "https://github.com/kdchain/go-kdchain/releases"
!define ABOUTURL "https://github.com/kdchain/go-kdchain#kdchain-go"
...
Section "Geth" GETH_IDX
  ...
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gkdchain.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gkdchain.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Geth incoming peers (TCP:31409)"
  SimpleFC::AdvRemoveRule "Geth outgoing peers (TCP:31409)"
  SimpleFC::AdvRemoveRule "Geth UDP discovery (UDP:31409)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Geth incoming peers (TCP:31409)" ""  6 1 1 2147483647 1 "$INSTDIR\gkdchain.exe" "" "" "Ethereum" 30303 "" "" ""
  SimpleFC::AdvAddRule "Geth outgoing peers (TCP:31409)" ""  6 2 1 2147483647 1 "$INSTDIR\gkdchain.exe" "" "" "Ethereum" "" 30303 "" ""
  SimpleFC::AdvAddRule "Geth UDP discovery (UDP:31409)" "" 17 2 1 2147483647 1 "$INSTDIR\gkdchain.exe" "" "" "Ethereum" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/kdchain/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\gkdchain.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\gkdchain.ipc"
