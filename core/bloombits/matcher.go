...
// that address/topic, and binary AND-ing those vectors togkdchainer.
	...
	go func() {
		...
		for {
			...
			case subres, ok := <-process:
				...
				// Gather all the sub-results and merge them togkdchainer
				var orVector []byte
...
// the reuested retrieval queue to be serviced togkdchainer with other sessions.
//
