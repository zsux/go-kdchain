...
import (
	...
	"github.com/kdchain/go-kdchain/contracts/chequebook"
	"github.com/kdchain/go-kdchain/contracts/ens"
	...
	httpapi "github.com/kdchain/go-kdchain/swarm/api/http"
	"github.com/kdchain/go-kdchain/swarm/fuse"
	"github.com/kdchain/go-kdchain/swarm/network"
	"github.com/kdchain/go-kdchain/swarm/storage"
)
...
func newEnsClient(endpoint string, addr common.Address, config *api.Config) (*ens.ENS, error) {
	...
	ensClient := kdclient.NewClient(client)
...
func detectEnsAddr(client *rpc.Client) (common.Address, error) {
	...
	block, err := kdclient.NewClient(client).BlockByNumber(ctx, big.NewInt(0))
	if err != nil {
		return common.Address{}, err
	}
